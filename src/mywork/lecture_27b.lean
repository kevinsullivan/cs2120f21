...
begin
  unfold bijective surjective injective,
  assume srAir,
  cases srAir with sr ir,
  cases sr with total rab,
  cases ir with total xy,
  ...
  cases total with f inv,
  unfold defined at inv,
  exact inv b,
  ...
  unfold total_function,
  apply and.intro,
  unfold function single_valued inverse,
  assume z x y rxz ryz,
  exact xy rxz ryz,
...
def bij_trans (s : β → γ → Prop)  (r : α → β → Prop) :
  ...
  begin
    ...
    assume a b,
    cases a with t1 t2,
    cases t1 with tr rab,
    cases t2 with tr rxy,
    cases b with t3 t4,
    cases t3 with ts sab,
    cases t4 with ts sxy,
    apply and.intro _ _,

    ---one
    apply and.intro,
    unfold total_function composition function single_valued defined,
    apply and.intro,
    assume x y z sary sarz,
    cases sary with b1,
    cases sary_h with sby rxb1,
    cases sarz with b2,
    cases sarz_h with sbz rxb2,
    unfold total_function at ts,
    cases ts with funcs d,
    unfold function at funcs,
    unfold single_valued at funcs,
    cases tr with funcr d,
    unfold function at funcr,
    unfold single_valued at funcr,
    have fr := funcr rxb1 rxb2,
    have fs := funcs sby,
    rw fs,
    rw fr,
    assumption,
    ...
    --two
    assume a,
    unfold total_function at ts tr,
    unfold function at ts tr,
    unfold single_valued at ts tr,
    unfold defined at ts tr,
    cases ts with syz bas,
    cases tr with ryz bar,
    have f1 := bar a,
    cases f1 with b,
    have f2 := bas b,
    cases f2 with c,
    apply exists.intro c,
    apply exists.intro b (and.intro f2_h f1_h),
    ...
    unfold composition,
    apply exists.intro c (and.intro f1_h f2_h),

    --four
    unfold total_function,
    apply and.intro _ _,
    unfold function composition single_valued defined,
    apply and.intro,
    assume x y z sby sbz,
    cases sby with b1 s1,
    cases s1 with sb1y rxb1,
    cases sbz with b2 s2,
    cases s2 with sb2z rxb2,
    unfold total_function at tr ts,
    cases tr with funcr,
    cases ts with funcs,
    unfold function at funcr funcs,
    unfold single_valued at funcs funcr,
    have f1 := funcr rxb1 rxb2,
    have f2 := funcs sb1y,
    rw f2,
    rw f1,
    assumption,
    ...
    cases f2 with c,
    apply exists.intro c,
    apply exists.intro b (and.intro f2_h f1_h), --this is the same as part two - same logic

    --six
    assume x y z sary sarz,
    cases sary with b1,
    cases sary_h with sb1z rxb1,
    cases sarz with b2,
    cases sarz_h with sb2z ryb2,
    unfold total_function at ts tr,
    unfold function at ts tr,
    unfold single_valued at ts tr,
    unfold defined at ts tr,
