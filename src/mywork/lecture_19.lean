...
begin
  ...
  exact rfl,
  -- case: n = 2
  cases h, --(1.add 0).succ is 1 + 0 = 1, succesor of 1 is 2. Really wierd
  /-
  show 2 ∈ evens,
  show evens 2,
  unfold evens,
  ...
  -/
  exact rfl,
end --how could I automate the case analysis since they all use refl as their core proof
...
begin
  intros α L X h, -- this just does all of our assumptions for us
